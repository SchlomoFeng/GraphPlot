...
def read_PipeFile():
    ...
    with open('/home/runner/work/GraphPlot/GraphPlot/0708烟台_updated.txt', 'r', encoding='utf-8') as file:
        data = json.load(file)
...
def create_directed_graph_visualization():
    ...
    # Save the plot
    plt.savefig('/home/runner/work/GraphPlot/GraphPlot/directed_pipeline_graph.png', 
